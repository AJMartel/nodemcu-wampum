return function (method, connection, wifiConfig, valuetable, badvalues)
    local utils = dofile("http_form-utils.lc")
    ...
    collectgarbage()
    dofile("http_wifigui-form-gen.lc")(utils, connection, wifiConfig, valuetable, badvalues)
    collectgarbage()
    dofile("http_wifigui-form-ap.lc") (utils, connection, wifiConfig, valuetable, badvalues)
    collectgarbage()
    dofile("http_wifigui-form-apnet.lc") (utils, connection, wifiConfig, valuetable, badvalues)
    collectgarbage()
    dofile("http_wifigui-form-sta.lc")(utils, connection, wifiConfig, valuetable, badvalues)
    collectgarbage()
    dofile("http_wifigui-form-stanet.lc")(utils, connection, wifiConfig, valuetable, badvalues)
    collectgarbage()
